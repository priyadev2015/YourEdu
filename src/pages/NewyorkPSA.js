...
const NewYorkPSA = () => {
  ...
  const mapFormToDb = (formData) => ({
    ...
    q1_date: formData.quarterly_report_dates[0],
    q2_date: formData.quarterly_report_dates[1],
    q3_date: formData.quarterly_report_dates[2],
    q4_date: formData.quarterly_report_dates[3],
  ...
  // Example usage:
  const rawDate = "2025-04-08"; // ✅ A real date in yyyy-mm-dd
  const formattedDate = formatDateForPostgres(rawDate);
  console.log(formattedDate); // Output: 2025-04-08 00:00:00
  console.log("Input value:", rawDate);
  ...
  console.log("DOB:", formData.student_dob);
console.log("Q1:", formData.q1_date);
console.log("Q2:", formData.q2_date);
console.log("Q3:", formData.q3_date);
console.log("Q4:", formData.q4_date);
console.log("Signature Date:", formData.signature_date);

  
  const handleSignAndSubmit = async () => {
    try {
      // ✅ Format all date fields before submitting
...
//   try {
//     const testData = {
//       parent_name: "Linda Martinez",
//       parent_email: "linda.martinez@example.com",
//       parent_phone: "321-654-9870",
//       parent_address: "789 Oak Avenue, Rivertown, CA",
//       student_name: "Michael Martinez",
//       student_dob: "2010-06-18 00:00:00",
//       student_grade: "7",
//       english_plan: "Poetry, grammar, and narrative writing",
//       english_materials: "Poetry Workbook, Grammar Guide",
//       math_plan: "Pre-algebra and data analysis",
//       math_materials: "Advanced Math Level 7",
//       science_plan: "Chemistry basics and lab experiments",
//       science_materials: "Hands-On Science Lab Kit",
//       social_studies_plan: "Ancient civilizations and global cultures",
//       social_studies_materials: "World Cultures Textbook",
//       health_plan: "Emotional intelligence and safety education",
//       health_materials: "Middle School Health Guide",
//       physical_education_plan: "Strength building and teamwork sports",
//       physical_education_materials: "Team Sports Manual",
//       art_plan: "Mixed media and digital art",
//       art_materials: "Tablet with stylus, Mixed Media Kit",
//       music_plan: "Instrument exploration and basic composition",
//       music_materials: "Intro to Music Instruments Pack",
//       q1_date: "2025-01-20",
//       q2_date: "2025-04-20",
//       q3_date: "2025-07-20",
//       q4_date: "2025-10-20",
