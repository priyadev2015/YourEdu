...
const ArtsTracksTable = ({ handleCourseClick: parentHandleClick }) => {
  ...
  const tracks = [
    {
      name: 'Advanced',
      courses: [
        { id: 'art-1-h', name: 'Art 1 Honors', year: 1 },
        { id: 'art-2-h', name: 'Art 2 Honors', year: 2 },
        { 
          id: 'year3',
          year: 3,
          options: [
            { id: 'ap-studio-2d', name: 'AP Studio Art 2D' },
            { id: 'ap-studio-3d', name: 'AP Studio Art 3D' }
          ]
        },
        { id: 'ap-art-history', name: 'AP Art History', year: 4 }
      ],
      color: 'hsl(160, 100%, 15%)' // Darker teal
    },
    {
      name: 'Standard',
      courses: [
        { id: 'art-1', name: 'Art 1', year: 1 },
        { id: 'art-2', name: 'Art 2', year: 2 },
        { id: 'art-3', name: 'Art 3', year: 3 },
        { id: 'art-4', name: 'Art 4', year: 4 }
      ],
      color: 'hsl(160, 80%, 30%)' // Medium teal, darker
    },
    {
      name: 'Minimum',
      courses: [
        { id: 'art-1-min', name: 'Art 1', year: 1 },
        { id: 'art-2-min', name: 'Art 2', year: 2 },
        { id: 'not-required-1', name: 'Not required', year: 3 },
        { id: 'not-required-2', name: 'Not required', year: 4 }
      ],
      color: 'hsl(160, 70%, 45%)' // Light teal, much darker for better readability
    }
  ];
...
export default ArtsTracksTable; 