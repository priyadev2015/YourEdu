...
const LanguageTracksTable = ({ handleCourseClick: parentHandleClick }) => {
  ...
  const tracks = [
    {
      name: 'Advanced',
      courses: [
        { id: 'spanish-1-h', name: 'Spanish 1 Honors', year: 1 },
        { id: 'spanish-2-h', name: 'Spanish 2 Honors', year: 2 },
        { id: 'spanish-3-h', name: 'Spanish 3 Honors', year: 3 },
        { id: 'ap-spanish', name: 'AP Spanish', year: 4 }
      ],
      color: 'hsl(340, 100%, 25%)' // Dark red
    },
    {
      name: 'Standard',
      courses: [
        { id: 'spanish-1', name: 'Spanish 1', year: 1 },
        { id: 'spanish-2', name: 'Spanish 2', year: 2 },
        { id: 'spanish-3', name: 'Spanish 3', year: 3 },
        { id: 'spanish-4', name: 'Spanish 4', year: 4 }
      ],
      color: 'hsl(340, 80%, 45%)' // Medium red
    },
    {
      name: 'Minimum',
      courses: [
        { id: 'spanish-1-min', name: 'Spanish 1', year: 1 },
        { id: 'spanish-2-min', name: 'Spanish 2', year: 2 },
        { id: 'not-required-1', name: 'Not required', year: 3 },
        { id: 'not-required-2', name: 'Not required', year: 4 }
      ],
      color: 'hsl(340, 70%, 65%)' // Light red, one shade darker
    }
  ];
...
export default LanguageTracksTable; 