...
DROP TABLE IF EXISTS ledger_entry_skills CASCADE;
DROP TABLE IF EXISTS ledger_entries CASCADE;
DROP TABLE IF EXISTS ledger_settings CASCADE;
...
CREATE TABLE ledger_entry_skills (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    entry_id UUID REFERENCES ledger_entries(id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX idx_ledger_entry_skills_entry_id ON ledger_entry_skills(entry_id);
