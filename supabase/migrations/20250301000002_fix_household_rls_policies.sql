-- Fix RLS policies for household tables to avoid infinite recursion
...
BEGIN
  ...
  -- Create household_invitations table if it doesn't exist
  ...
  DROP POLICY IF EXISTS "Users can insert household invitations" ON public.household_invitations;
